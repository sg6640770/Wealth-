    ...
    <section className="bg-indigo-50 py-10 px-4 text-center">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
          Invest Smarter, Earn More</h1>
        <h3 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6"> AI-Powered Investment Strategies for
        <br/><span className="text-indigo-600">Maximum Returns</span>
        </h3>
